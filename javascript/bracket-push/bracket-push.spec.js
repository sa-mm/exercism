...
describe('bracket push', function () {
  ...
  it('handles non-bracket characters enclosed in characters', function () {
    expect(bracket('{a}')).toEqual(true)
  })

  // it('handles non-bracket characters not enclosed in characters', function () {
  //   expect(bracket('a{}')).toEqual(true)
  // })
